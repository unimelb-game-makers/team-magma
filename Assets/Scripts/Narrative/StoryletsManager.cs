...
namespace Narrative
{
    public class StoryletsManager
    {
        ...
        public bool IsReady => _storyletState == StoryletState.REFRESH_COMPLETE;
        public bool IsRefreshing => _storyletState == StoryletState.REFRESHING;
        public bool NeedsRefresh => _storyletState == StoryletState.NEEDS_REFRESH;
        ...
        public void AddStorylets(string prefix)
        {
            ...
            _storyletState = StoryletState.NEEDS_REFRESH;
        }
        ...
        public void Refresh()
        {
            ...
            _storyletState = StoryletState.REFRESHING;
        }
        ...
        public void Tick()
        {
            if (_storyletState != StoryletState.REFRESHING)
                return;
            ...
            if (_refreshList.Count == 0)
            {
                _storyletState = StoryletState.REFRESH_COMPLETE;
        ...
        {
            if (_storyletState != StoryletState.REFRESH_COMPLETE)
            {
        ...
        private enum StoryletState
        {
            NEEDS_REFRESH,
            REFRESHING,
            REFRESH_COMPLETE
        }
        private StoryletState _storyletState = StoryletState.NEEDS_REFRESH;
