...
== enter_lvl1_village ==
*{did_player_competently_enter_lvl1_village ==false} -> found_by_old_lady
*-> hub_character_hub

== hub_character_hub ==
Who will you talk to?
* [Ralphie y] -> talk_to_ralphie
* [Paul n] -> talk_to_paul 
* [Old lady y] -> talk_to_agatha
...
- I suppose they mean well. They're just trying to protect their home, and the rest of us, but they take it too far sometimes, and end up roughing up young ladies such as yourself. It's not right.
...
*   ->
    ...
    **[Pretty bad.]
        ~ralphie_trust += 1
        That's why I don't drink the stuff! Agatha
        {
...
*[Are you the guy with the hat?]
    Ah, who sent you? Intelligence? Police? Military? I thought they gave up on that operation...
    **[Department of Transport?]
        Oh, shit. I didn't say anything, alright?
       * **[My lips are sealed.]
            ~paul_trust +=1
...
*[You're voting on it?]
    Yep. We're all gonna vote when that... attractive young girl gets back from her supply run.
...
{!agatha_conversation_intro: ->agatha_conversation_intro|Hello again, dear.->agatha_conversation_body}
...
*[Do you know anything about stolen tapes?]
    ...
    -> agatha_conversation_body
*{talk_to_paul} [How do you feel about going back up to the city?]
        Ah. 
        That.
        Well, uh...
        *cough*
